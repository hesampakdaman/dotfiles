...
#+begin_src emacs-lisp
  ...
  ;; sets custom file (loading occurs in init.el)
...
#+begin_src emacs-lisp
  (use-package eglot
    ...
    (before-save . hesam/eglot-format-buffer))

  (defun hesam/eglot-format-buffer ()
    "Format buffer if Eglot server supports formatting."
...
#+begin_src emacs-lisp
  ...
  ;; Add it as a hook to adhere with changes when switching theme
  ;; during run-time.
  (add-hook
   'enable-theme-functions
