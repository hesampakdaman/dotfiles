...
#+begin_src toml :noweb yes
  ...
  left = [ "Workspaces" ]
  center = []
  right = [ "Tempo", [ "Updates", "Settings" ] ]

  [updates]
  check_cmd = "checkupdates; yay -Qua"
  update_cmd = 'ghostty -e bash -c "yay; echo Done - Press enter to exit; read" &'
  interval = 10800
...
#+begin_src lua :tangle ~/.config/hypr/hyprland.lua
  ...
  hl.on("hyprland.start", function()
      ...
      hl.exec_cmd('emacsclient --eval "(setenv \\"WAYLAND_DISPLAY\\" \\"' ..
  ...
  hl.env("EDITOR", "emacsclient -c")
  hl.env("VISUAL", "emacsclient -c")
  hl.env("SUDO_EDITOR", "emacsclient -c")
  ...
  local kbLayouts = { "us", "se" }
  local currentKb = 1

  hl.bind(mainMod .. " + SPACE", function()
      currentKb = (currentKb % #kbLayouts) + 1
      hl.exec_cmd("hyprctl switchxkblayout all " .. (currentKb - 1))
      hl.exec_cmd("notify-send -t 1000 'Keyboard' '" .. kbLayouts[currentKb] .. "'")
  end)

  -- layouts
  local layouts = { "master", "dwindle", "lua:columns" }
  local current = 1
  ...
  hl.bind(mainMod .. " + ALT + SPACE", function()
      ...
      hl.exec_cmd("notify-send -r 991 -t 1000 'Layout' '" .. layout .. "'")
  end)
  ...
  -- Apps like to request maximization on their own (e.g. when they open
  -- for the first time) this rule silently suppresses those requests
  hl.window_rule({
